...
params = scall.args
#print(params[0].val.type)
# print(idc.get_strlit_contents(params[1]))
expr = params[1].val
print(dir(expr))
#print(hex(expr.obj_ea))
...
#print(expr.y.n.value(expr.y.type))
#print(expr.y.n._value)

print('ida_hexrays.cot_idx', ida_hexrays.cot_idx)
print('ida_hexrays.cot_var', ida_hexrays.cot_var)
print('ida_hexrays.cot_ref', ida_hexrays.cot_ref)
print('ida_hexrays.cot_obj', ida_hexrays.cot_obj)
print('ida_hexrays.cot_num', ida_hexrays.cot_num)

#string_val = idc.get_strlit_contents(expr.x.obj_ea)
#print(string_val)

#print(params[1].val.y)
#print(dir(params[1].val.y))
#print(params[1].val.y.is_expr())
```
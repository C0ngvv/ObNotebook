...
```json
{'last_func_info': {'func_addr': '0x42b08', 'push_skip': 0, 'push_addr': '0x42b08', 'lr_index': 2}, 'in_func_list': ['0x42b08'], 'last_func_addr': '0x42b08', 'callsite2func_map': {'0x42c44': '0x42b08', '0x42c78': '0x42b08', '0x42ccc': '0x42b08', '0x42d4c': '0x42b08', '0x42d64': '0x42b08', '0x42e70': '0x42b08', '0x42f94': '0x42b08', '0x43170': '0x42b08'}}
```
...
已识别
```json
{'last_func_info': {'func_addr': '0xb3560', 'push_skip': 0, 'push_addr': '0xb3560', 'lr_index': 2}, 'in_func_list': ['0xb3560'], 'last_func_addr': '0xb3560', 'callsite2func_map': {'0xb38cc': '0xb3560'}}
```
...
```json
{'last_func_info': {'func_addr': '0x6b5d8', 'push_skip': 0, 'push_addr': '0x6b5d8', 'lr_index': 2}, 'in_func_list': ['0x6b5d8'], 'last_func_addr': '0x6b5d8', 'callsite2func_map': {'0x6b828': '0x6b5d8', '0x6b854': '0x6b5d8'}}
```
...
```
{'last_func_info': {'func_addr': '0x25e04', 'push_skip': 0, 'push_addr': '0x25e04', 'lr_index': 1}, 'in_func_list': ['0x25e04'], 'last_func_addr': '0x25e04', 'callsite2func_map': {'0x25e70': '0x25e04'}}
```
...
root cause: 0x7e0d8
```json
{'last_func_info': {'func_addr': '0x7dd20', 'push_skip': 0, 'push_addr': '0x7dd20', 'lr_index': 2}, 'in_func_list': ['0x7dd20'], 'last_func_addr': '0x7dd20', 'callsite2func_map': {'0x7e0d8': '0x7dd20', '0x7e174': '0x7dd20'}}
```
...
root cause: 0x4ecf4
```json
{'last_func_info': {'func_addr': '0x4ec58', 'push_skip': 0, 'push_addr': '0x4ec58', 'lr_index': 2}, 'in_func_list': ['0x4ec58'], 'last_func_addr': '0x4ec58', 'callsite2func_map': {'0x4ecf4': '0x4ec58', '0x4ed60': '0x4ec58'}}
```
